export const companyInfo = {
  ...
  brand: "慧拼读",
  description:
    "慧拼读是一家专注于英语单词拼读系统的品牌，致力于为孩子打造科学、高效、充满趣味的单词学习系统。我们以单词拼读为核心，结合单词学习规律研发出系统化、循序渐进的单词学习系统，帮助孩子建立\"见词能读、听音能写\"的单词学习能力。"
} as const;
...
export const pageCopy = {
    ...
    sections: [
      {
        title: "我们专注什么",
        description:
          "慧拼读围绕英语单词拼读与单词学习，帮助孩子从字母音、音节、拼读规律到听写表达逐步建立英语基础能力。"
      },
      {
        title: "我们的教学理念",
        description:
  ...
  curriculum: {
    ...
    title: "课程体系",
    description:
      "慧拼读课程以单词拼读和单词学习为核心，从拼读规律、单词训练、科学记忆到阅读与复习巩固逐步进阶，帮助孩子真正掌握单词学习方法。",
    ...
    sections: [
      ...
      },
      {
        title: "第三阶段：巩固提升",
        description:
          "通过阅读、语法、复习打卡和阶段测评，让孩子把拼读能力迁移到真实单词学习场景。"
      }
    ],
  ...
  cooperation: {
    ...
    title: "合作加盟",
    description:
      "慧拼读面向小初高教培机构、托管校区、社区教育中心和区域合作伙伴，提供英语单词拼读系统、教学支持与运营协同方案。",
    ...
    sections: [
      ...
      },
      {
        title: "适合托管与课后服务",
        description:
          "用标准化系统组织小班训练，帮助校区增加单词学习服务，提高家长认可度。"
      },
      {
        title: "适合区域合作伙伴",
        description:
  ...
  contact: {
    ...
    title: "联系我们",
    description:
      "欢迎教培机构与代理伙伴咨询合作模式，我们会根据你的使用场景匹配适合的套餐方案。详情可以滑动到底部查看联系方式。",
    ...
    sections: [
      ...
      },
      {
        title: "学校机构合作咨询",
        description:
          "面向学校、教培机构、托管校区和课后服务场景，提供课程引入、系统使用和教学方案支持。"
      },
      {
        title: "代理和区域合作",
        description:
...
export const homeCopy = {
  hero: {
    ...
    title: "让孩子真正掌握英语拼读规律",
    description:
      "慧拼读系统专注英语单词拼读学习，帮助孩子从“看词不会读”到“见词能拼、听音能写”。",
    primaryCta: "了解课程体系",
    secondaryCta: "咨询合作",
    stats: [
  ...
  what: {
    title: "慧拼读是什么",
    description: companyInfo.description,
    points: ["专注英语单词拼读系统", "系统化、循序渐进的单词学习", "建立见词能读、听音能写的能力"]
  },
  audience: {
    title: "适合谁使用",
    items: [
  ...
  curriculum: {
    title: "课程体系",
    description:
      "以单词拼读训练为核心，逐步延展到音标、词汇、句型、阅读与抗遗忘复习，让孩子在反复听、拼、读、写中建立单词学习底层能力。",
  ...
  institutions: {
    title: "适合机构",
    description:
      "慧拼读适合英语培训机构、托管校区、素质教育中心、社区教育空间和区域代理伙伴引入，用标准化系统提升课程交付与运营效率。",
    items: ["英语培训机构", "托管与课后服务校区", "社区教育中心", "区域合作代理"]
  },
  contact: {
    title: "联系我们",
    description:
      "欢迎教培机构与代理伙伴咨询合作模式，我们会根据你的使用场景提供匹配的系统套餐方案。",
    cta: "咨询合作"
  }
} as const;
