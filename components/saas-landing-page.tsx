...
function DeviceShowcase() {
  return (
    <div className="relative mx-auto max-w-[860px] pt-4">
      ...
      <img
        src="/images/hero-device-showcase-transparent.png"
        alt="慧拼读训练系统电脑、平板和手机展示"
...
function SectionTitle({ eyebrow, title, subtitle }: { eyebrow: string; title: string; subtitle?: string }) {
  return (
    <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-80px" }} className="mx-auto mb-7 max-w-3xl text-center md:mb-12">
      <p className="text-base font-black uppercase tracking-[0.12em] text-[#165DFF] md:text-lg">{eyebrow}</p>
